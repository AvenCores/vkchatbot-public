...
keyboard.add_button('Free Telegram ChatGPT Bot', color=VkKeyboardColor.POSITIVE)
...
Система: {platform}
    """)
                addbottg = "---Реклама---\n🔽Наш бесплатный Telegram Bot ChatGPT🔽 https://t.me/avencoreschatgpt_bot\n---Реклама---"

                texsupport = "Я в VK: https://vk.com/avencores\nЯ в Telegram: https://t.me/avencores"

                dolbaebdetected = "Чтобы попасть в главное меню напиши <<Меню>>. \n\nЕсли вы реально пытаетесь задать выпрос в данное сообщество, то вы ДОЛБАЕБ и как личность НИКТО. Написано же, что в самом сообществе нету ChatGPT! Он находится по ссылке ниже, а именно в моем телеграм боте. \n\n🔽Наш бесплатный Telegram Bot ChatGPT🔽\nhttps://t.me/avencoreschatgpt_bot"
                ...
                elif text == "free telegram chatgpt bot":
